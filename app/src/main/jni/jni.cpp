...
#include "com_usbcam_pngcui_usbcamdemo_Jni.h"
...
int opendevice(int i)
{
    struct stat st;
//    if(i == 0){
//        sprintf(dev_name,"/dev/usb/video4linux1-1.4");
//    }else if(i == 1){
//        sprintf(dev_name,"/dev/usb/video4linux1-1.6");
//    }
    ...
    LOGE("open /dev/video%d success %d",i,fd);
...
jint
Java_com_usbcam_pngcui_usbcamdemo_Jni_prepareCamera( JNIEnv* env,jobject thiz, jint videoid){
	LOGE("prepareCamera");
    int ret;
...
jint
Java_com_usbcam_pngcui_usbcamdemo_Jni_prepareCameraWithBase(JNIEnv *env, jobject thiz, jint videoid, jint videobase){
    LOGE("prepareCameraWithBase");
}
...
void
Java_com_usbcam_pngcui_usbcamdemo_Jni_processCamera(JNIEnv *env, jobject thiz){
    //LOGE("processCamera");
    readframeonce();
}

void
Java_com_usbcam_pngcui_usbcamdemo_Jni_stopCamera(JNIEnv *env, jobject thiz){
    LOGE("stopCamera");
...
void
Java_com_usbcam_pngcui_usbcamdemo_Jni_pixeltobmp(JNIEnv *env, jobject thiz, jobject bitmap){
    jboolean bo;
